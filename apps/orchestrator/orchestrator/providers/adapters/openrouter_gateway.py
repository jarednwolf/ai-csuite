...
class Adapter(LLMGateway):
    ...
    def route(self, prompt: str, tags: Sequence[str]) -> Mapping[str, Any]:
        # No network calls in tests; deterministic fallback
        return {"chosen_model": "openrouter/disabled", "policy": {"disabled": True}, "explanations": ["feature-flagged off"]}
